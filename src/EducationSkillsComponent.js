...
const EducationSkillsComponent = () => {
  ...
  const educationData = [
    { year: 2024, institution: ' Masters of Computer Application', degree: 'Dayanand Sagar College' },
    { year: 2022, institution: 'Bachelors of Science', degree: 'Vivekananda Degree College ' },
    { year: 2019, institution: ' PUC (12th)', degree: 'seshadripuram composite pu college' },
